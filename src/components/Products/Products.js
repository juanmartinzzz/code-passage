...
const ProductCard = ({title, videoUrl, legend}) => (
    <Card sx={{p:2}}>
        <Stack alignContent="center" alignItems="center" spacing={2} sx={{pl:8, pr:8}}>
            {/* <Container sx={{p:2}}> */}
                <Typography variant="h3">{title}</Typography>
                <iframe width="560" height="315" src={`https://www.youtube-nocookie.com/embed/${videoUrl}`} title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
